...
*	The swarmboids have 3 states, Swarm, Intercept and Evade. 
*	
...
*	There are 3 different types of powerups in this game: Health boost, Shield and Speed boost. Health boost increases the player's health, Shield stops the player taking
...
*	Obstacles are represented by animated asteriod sprites. They move around the world with a random velocity. 
...
*	The interceptor works exactly as is outlined in the requirements.
*
