#ifndef PIXEL_PERFECT_HPP
#define PIXEL_PERFECT_HPP
...
namespace PixelPerfect{
	...
	static bool Collision(const sf::Sprite& spriteA, const sf::Sprite& spriteB, const sf::Image& imgA, const sf::Image& imgB) {
